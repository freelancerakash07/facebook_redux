            ...
            <div className="row">
                ...
                <div className="col-md-4 right">
                    <div className="fb_header_right_menu">
                        <ul>
                            <li><a href=""><span><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" className="x19dipnz x1lliihq x1k90msu x2h7rmj x1qfuztq" style="--color:var(--primary-icon)"><path d="M12 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM4 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm8 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm8 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm0-8a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM4 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm8 16a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm8 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM4 17a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"></path></svg></span></a></li>
                        ...
                        <div className="fb_left_menu">
                            <ul>
                               ...
                               <li><a href="">
                                <div className="list_items">
                                    <div className="list_img">
                                        <i data-visualcompletion="css-img" className="" style="background-image:url('https://static.xx.fbcdn.net/rsrc.php/v3/yz/r/4GR4KRf3hN2.png?_nc_eui2=AeEUIbN3vkJ_nWxvOLQ5bMwTiXYVTRy2fzKJdhVNHLZ_MgFn16vZ-wIunj4JU3gc2VMmxuOG91AuscKR5idhwkfX');background-position:0 -296px;background-size:auto;width:36px;height:36px;background-repeat:no-repeat;display:inline-block"></i>
                                    </div>
                                    <div className="list_text">
                                        <p>Friends</p>
                                    </div>
                               ...
                               <li><a href="">
                                <div className="list_items">
                                    <div className="list_img">
                                        <svg viewBox="0 0 16 16" width="20" height="20" fill="currentColor" className="x19dipnz x1lliihq x1k90msu x2h7rmj x1qfuztq" style="--color: var(--primary-icon);"></svg>
                                    </div>
                                    <div className="list_text">
                                        <p>See more</p>
                        ...
                        <div className="fb_body_right_ariya">
                            ...
                            <div className="fb_body_right_brithday_section">
                                ...
                                <div className="fb_body_right_brithday_section_body">
                                   <img src="./assets/img/jGIHAYEO3Pc (1).png" alt=""/>
